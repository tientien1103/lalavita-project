...
function Section1() {
  return (
    <Container className="max-w-screen-xl 3xl:max-w-screen-2xl">
      <div className="w-full pt-14 lg:pt-24 2xl:pt-72 2xl:pb-72 3xl:pb-0 3xl:pt-20">
        <div className="flex flex-col-reverse items-center 2xl:flex-row 2xl:justify-between">
          <div className="flex flex-col gap-2 2xl:gap-6 3xl:gap-10 mt-4 lg:mt-20">
            ...
            <Image
              ...
              width={49}
              height={49}
              className="object-contain 3xl:pt-24 2xl:pt-5 lg:pt-10 pt-8 2xl:self-start self-center"
            />
          </div>
