...
function Section2() {
  return (
    <div className="min-h-screen bg-[#fed614]">
      <Container className="max-w-screen-xl 3xl:max-w-screen-2xl">
        <div className="flex flex-col items-center justify-center pt-20 lg:pt-60 2xl:py-2 3xl:py-24">
          <div className="flex flex-col gap-4">
            <p className="text-[#42c0cc] lg:text-lg text-sm font-semibold text-center">
              NMN는 왜 중요할까요?
            </p>
            <h3 className="lg:text-[40px] lg:leading-[48px] text-2xl font-semibold text-center text-[#222222]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 place-items-center space-y-4 lg:space-x-4 xl:space-x-8 pt-2 lg:pt-16 2xl:pt-4 3xl:pt-16">
            {CARD_LIST.map((card, index) => (
              <div
                key={`card ${index + 1}`}
                style={{ backgroundColor: card.bgColor }}
                className={clsx(
                  "space-y-4 lg:space-y-7 rounded-[20px] 2xl:w-[380px] 3xl:h-[448px] 2xl:h-[420px] lg:h-[448px] lg:w-[327px] w-[300px] h-[120px] lg:pt-10 xl:px-10 px-5 pt-5",
                  {
                    "mt-6 lg:ml-3 2xl:ml-8": index === 0,
                  }
                )}
              >
